...
{
    public class BimProjectFoldersApi : APSApi    {
        ...
        public RestResponse GetFolderContents(string projectId, string folderId)
        {
            ...
            var request = new RestRequest(Urls["folders_folder_contents"]);
        ...
        public IList<Folder> GetSubFolders(string projectId, string folderId)
        {
            ...
            try
            {
                ...
                var uri = string.Format("{0}{1}/folders/{2}/contents",
                                                 "data/v1/projects/",
                                                 projectId,
                                                 folderId);
        ...
        public NestedFolder GetFoldersHierarchy(string projectId, NestedFolder thisFolder)
        {
            ...
            try
            {
                ...
                RestResponse res = GetFolderPermissions(projectId, thisFolder.id, out folderPermissions);
        ...
        /// <returns></returns>
        public RestResponse GetFolderPermissions(string projectId, string folderId, out List<FolderPermission> result)
        {
            ...
            var request = new RestRequest(Urls["folder_permission"]);
        ...
        public string CreateFolder(string projectId, string userId, string parentFolderId, string newFolderName)
        {
            ...
            var uri = string.Format("{0}{1}/folders",
                                              "data/v1/projects/",
                                              projectId);
        ...
        public bool AssignPermission(string projectId,  string folderId, List<FolderPermission> folderPermissions,  string userId )
        {
            ...
            var request = new RestRequest(Urls["folder_permission_create"], Method.Post);
            request.AddParameter("ProjectId", projectId, ParameterType.UrlSegment);
            request.AddParameter("FolderId", folderId, ParameterType.UrlSegment);
        ...
        /// classes and parameters.  Later when more commands are used in APS, then it might make sense to deserialize.
        /// </summary>
